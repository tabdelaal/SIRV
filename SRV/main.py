...
-------
    ...
    SRV: Spatial differentiation analysis with RNA velocity
...
def SRV(Spatial_data,RNA_data,n_pv,metadata_to_transfer=None):
    """
        @author: Tamim Abdelaal
    ...
    if metadata_to_transfer is SRV.__defaults__[0]:
